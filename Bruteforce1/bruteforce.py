...
if __name__ == '__main__':
    ...
    with open("/Users/alijakvani/Documents/mini_project_python/Bruteforce1/passwords.txt") as pw:
        #read_data = pw.read()
        for line in pw:
            line = line.rstrip()
            
            connect(host, user, line)
            if Found == True:
                print("The bruteforce tool cracked the code after " + str(Fails) + " attempts.")
                sys.exit()
